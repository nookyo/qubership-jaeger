...
**Warning!** Since Jaeger release `2.x`, `cassandraSchemaJob.ttl` parameters (`trace` and `dependencies`) must be set with a suitable unit (`s` - seconds, `m` - minutes, `h` - hours, `d` - days).
...
| `ttl.trace`                | integer                                                                                                                       | no        | -                                                                                                                                         | Time to live for traces (in seconds, minutes, hours, days) data                                                                                                                                                                                                                                                                                                             |
| `ttl.dependencies`         | integer                                                                                                                       | no        | -                                                                                                                                         | Time to live for dependencies (in seconds, minutes, hours, days) data                                                                                                                                                                                                                                                                                                        |
| `priorityClassName`        | string                                                                                                                        | no        | `-`                                                                                                                                       | PriorityClassName assigned to the Pods to prevent them from evicting.                                                                                                                                                                                                                                                                                 |
